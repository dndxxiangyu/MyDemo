package com.seu.test.extension.rules
 ...
 * describe:
 */
import com.seu.test.extension.hasCommentInPrivateMember
...
class CommentOverPrivateFunction(config: Config = Config.empty) : Rule(config) {
    ...
    override fun visitNamedFunction(function: KtNamedFunction) {
        if (function.hasCommentInPrivateMember()) {
            report(
                CodeSmell(
                    issue, Entity.from(function), "The function ${function.nameAsSafeName} " +
